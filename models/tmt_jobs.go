...
type TMTJob struct {
	...
	CompanyDomain           string      `boil:"company_domain" json:"company_domain" toml:"company_domain" yaml:"company_domain"`
...
var TMTJobTableColumns = struct {
	...
	CompanyDomain:           "tmt_jobs.company_domain",
...
var TMTJobWhere = struct {
	...
	CompanyDomain           whereHelperstring
	...
	CompanyDomain:           whereHelperstring{field: "\"tmt_jobs\".\"company_domain\""},
...
var (
	tmtJobAllColumns            = []string{"id", "change_request_id", "project_name", "orchestration_repository", "application", "company_domain", "user_email", "created_at", "completed_at", "status", "status_message"}
	tmtJobColumnsWithoutDefault = []string{"change_request_id", "project_name", "orchestration_repository", "application", "company_domain", "user_email", "status"}
