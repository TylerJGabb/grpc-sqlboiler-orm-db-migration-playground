...
func (r *userR) GetVideos() VideoSlice {
	if r == nil {
		return nil
	}
	return r.Videos
...
func (o *User) Videos(mods ...qm.QueryMod) videoQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"video_tags\" on \"videos\".\"id\" = \"video_tags\".\"video_id\""),
		qm.Where("\"video_tags\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadVideos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.Select("\"videos\".\"id\", \"videos\".\"name\", \"a\".\"user_id\""),
		qm.From("\"videos\""),
		qm.InnerJoin("\"video_tags\" as \"a\" on \"videos\".\"id\" = \"a\".\"video_id\""),
...
func (o *User) AddVideos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Video) error {
	var err error
	...
	for _, rel := range related {
		query := "insert into \"video_tags\" (\"user_id\", \"video_id\") values ($1, $2)"
...
// Sets o.R.Users's Videos accordingly.
// Replaces o.R.Videos with related.
// Sets related.R.Users's Videos accordingly.
func (o *User) SetVideos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Video) error {
	query := "delete from \"video_tags\" where \"user_id\" = $1"
	...
	removeVideosFromUsersSlice(o, related)
	if o.R != nil {
		o.R.Videos = nil
	}
...
func (o *User) RemoveVideos(ctx context.Context, exec boil.ContextExecutor, related ...*Video) error {
	if len(related) == 0 {
		return nil
	}
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"video_tags\" where \"user_id\" = $1 and \"video_id\" in (%s)",
...
func removeVideosFromUsersSlice(o *User, related []*Video) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
