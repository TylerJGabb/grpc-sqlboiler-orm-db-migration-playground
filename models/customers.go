...
func (r *customerR) GetInvoices() InvoiceSlice {
	if r == nil {
		return nil
	}
	return r.Invoices
...
var (
	...
	customerColumnsWithoutDefault = []string{"name"}
...
func (o *Customer) Invoices(mods ...qm.QueryMod) invoiceQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"invoices\".\"customer_id\"=?", o.ID),
	)
...
func (customerL) LoadInvoices(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCustomer interface{}, mods queries.Applicator) error {
	var slice []*Customer
	var object *Customer
	...
	query := NewQuery(
		qm.From(`invoices`),
		qm.WhereIn(`invoices.customer_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Customer) AddInvoices(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Invoice) error {
	var err error
